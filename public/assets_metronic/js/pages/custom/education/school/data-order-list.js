        ...
        var datatable = $('#kt_datatable').KTDatatable({
            ...
            columns: [
            {
                ...
                template:function(row){
                    return `<a href="/admin/order/` + row.serial_number + `">`+ row.serial_number +`</a>`;
                }
            }, {
                field: 'user_id',
                title: 'User',
            },
            {
                ...
                template: function(row) {
                    ...
                    return  `<div class=''><i class="` + status[row.completed].class + ` label-inline">` + `</i></div>`;
                },
            },
            {
                field: 'Actions',
                ...
                template: function(row) {
                    if(row.completed == 0){
                        ...
                        return `<a class="btn btn-icon btn-light-danger btn-circle btn-sm mr-2" title="Delete" onclick="onDelete(` + row.id + `, this)">\
                                    <span class="svg-icon svg-icon-md">\
                                        <svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width="24px" height="24px" viewBox="0 0 24 24" version="1.1">\
                                            <g stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">\
                                                <rect x="0" y="0" width="24" height="24"/>\
