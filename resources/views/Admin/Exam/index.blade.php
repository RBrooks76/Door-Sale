                    ...
                    <div class="d-flex align-items-center">
                        ...
                        <button class="btn p-0 ml-2" id="kt_header_mobile_topbar_toggle">
                            <span class="svg-icon svg-icon-xl">
                                ...
                                <svg xmlns="http://www.w3.org/2000/svg" xmlns:xli nk="http://www.w3.org/1999/xlink" width="24px" height="24px" viewBox="0 0 24 24" version="1.1">
                                    ...
                                    <div class="card card-custom">
                                        ...
                                        <div class="card-header flex-wrap border-0 pt-6 pb-0">
                                            <h3 class="card-title align-items-start flex-column">
                                                <span class="card-label font-weight-bolder text-dark">Problems for Examination</span>
                                                    ...
                                                    <div class="col-lg-12 col-xl-12">
                                                        <div class="row align-items-center">
                                                            ...
                                                            <div class="col-md-3 my-2 my-md-0">
                                                                <select class="form-control form-control-solid" id="CID" onchange="getLIDList()" name="CID">
