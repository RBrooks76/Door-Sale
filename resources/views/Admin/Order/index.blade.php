                                        ...
                                        <div class="card-header flex-wrap border-0 pt-6 pb-0">
                                            ...
                                            <div class="card-toolbar">
                                                <div class="dropdown dropdown-inline" data-toggle="tooltip" title="" data-placement="left" data-original-title="Quick actions">
                                                    <!--begin::Trigger Modal-->
                                                    <a href="#" class="btn btn-success font-weight-bolder font-size-sm" aria-haspopup="true" aria-expanded="false" data-toggle="modal" data-target="#exampleModalCustomScrollable">New User</a>
                                                    <!--end::Trigger Modal-->
                                                    <!--begin::Modal Content-->
                                                            ...
                                                            <div class="modal-content">
                                                                ...
                                                                <div class="modal-body">
                                                                    <div data-scroll="true" data-height="300">
                                                                        <form class="form pt-9" method="POST" action="{{ route('onUserSignup') }}">
                                                                            @csrf
                                                                            ...
                                                                            <div class="modal-footer">
                                                                                ...
                                                                                <button type="submit" class="btn btn-primary font-weight-bold">Add User</button>
                                                                            </div>
                                                                        </form>
                                                                    </div>
                                                                </div>
