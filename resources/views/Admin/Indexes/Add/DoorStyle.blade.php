                ...
                <div class="row">
                    <div class="col-md-12">
                        ...
                        <div class="card card-custom gutter-b example example-compact">
                            ...
                            @endif
                            <!--begin::Form-->
                            <form method="POST" action="{{route('onDoorStyle')}}">
                                @csrf
                                <div class="card-body">
                                    <div class="form-group">
                                        <label for="exampleInputPassword1">Door Style Name
                                            <span class="text-danger">*</span>
                                        </label>
                                        <input type="type" class="form-control" id="exampleInputPassword1" placeholder="Name"  name="name" value="{{ old('name') }}"/>
                                    </div>
                                    <div class="form-group">
                                        <label for="exampleInputPassword1">Selection Code
                                            <span class="text-danger">*</span>
                                        </label>
                                        <input type="type" class="form-control" id="exampleInputPassword1" placeholder="Code"  name="code" value="{{ old('code') }}"/>
                                    </div>
                                    <div class="form-group mb-1">
                                        <label for="exampleTextarea">Door Style Comment
                                        </label>
