                ...
                <div class="row">
                    <div class="col-md-12">
                        ...
                        <div class="card card-custom gutter-b example example-compact">
                            ...
                            @if($errors->has('CID') || $errors->has('name') || $errors->has('content') )
                            ...
                            @endif
                            <!--begin::Form-->
                            <form method="post" action="{{route('onAddTeacherLevel')}}">
                                @csrf
                                <div class="card-body">
                                ...
                                <div class="card-footer card-footer-right">
                                    <button type="submit" class="btn btn-primary mr-2">Add Level</button>
