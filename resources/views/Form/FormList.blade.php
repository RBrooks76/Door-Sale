...
@section('content')
                                    ...
                                    <div class="card card-custom">
                                        ...
                                        <div class="card-header flex-wrap border-0 pt-6 pb-0">
                                            <h3 class="card-title align-items-start flex-column">
                                                <span class="card-label font-weight-bolder text-dark">Forms List</span>
                                            </h3>
                                            <div class="card-toolbar">
                                                <div class="dropdown dropdown-inline" data-toggle="tooltip" title="" data-placement="left" data-original-title="Quick actions">
                                                    <a href="{{ route('toPaintedDoorOrderContent') }}" class="btn btn-success font-weight-bolder font-size-sm">Add More</a>
                                                    <!--begin::Trigger Modal-->
                                                    {{-- <a class="btn btn-success font-weight-bolder font-size-sm" aria-haspopup="true" aria-expanded="false" data-toggle="modal" data-target="#exampleModalCustomScrollable">Add More</a> --}}
                                                    <!--end::Trigger Modal-->
                                                    <!--begin::Modal Content-->
                                                        ...
                                                        <div class="modal-dialog modal-dialog-scrollable modal-dialog-centered modal-lg" role="document">
                                                            <div class="modal-content">
                                                                <div class="modal-header">
                                                                    <h5 class="modal-title" id="exampleModalLabel">Add Painted Door Order</h5>
    ...
    <!--end::Scrolltop-->
	<script src="assets_metronic/js/pages/custom/education/school/data-form-list.js"></script>
    <script>
