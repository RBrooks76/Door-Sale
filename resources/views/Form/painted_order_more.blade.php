                                            ...
                                            <tbody>
                                                <tr>
                                                    <tr id="first_row">
                                                        ...
                                                        <td>
                                                            <input type="text" class="table-input" name="" onchange="onCalculation()">
                                                        </td>
                                                        <td>
                                                            <input type="text" class="table-input" name="" onchange="onCalculation()">
                                                        </td>
                                                    ...
                                                    <tr id="fifth_row">
                                                        ...
                                                        <td>
                                                            <select class="form-control form-control-solid" name="finish_sixth" id="finish_sixth" onchange="onCalculation()">
                                                                <option value=""></option>
