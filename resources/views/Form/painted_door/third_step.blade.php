...
<div class="d-flex flex-column flex-root">
    <div class="d-flex flex-row flex-column-fluid page">
        <div class="d-flex flex-column flex-row-fluid wrapper" id="kt_wrapper">
            ...
            <div class="d-flex flex-row flex-column-fluid container max-width-90">
                            ...
                            <div class="card card-custom example example-compact">
                                <div class="card-header">
                                    <h3 class="card-title">Painted Door - Purchase Order &nbsp;<b
                                        style="font-size : 25px">Third Step</b></h3>
                                </div>
                                <div class="col-lg-12 my-3 flex flex-column" style="display: table-cell">
                                    <table class="col-lg-12 table third-step-table" id="table">
                                        <thead class="">
                                            <tr class="top-header">
                                        ...
                                        <tbody>
                                            <tr id="first_row">
                                                ...
                                                <td rowspan="5" width="150">
                                                    <select class="form-control form-control-solid" name="door_category" id="door_category" onchange="onChangeDoorCategory('')">
                                                        ...
                                                        @foreach ($doorstyle as $item)
                                                            <option value="{{ $item->id }}" {{$chosenData['door_style'] == $item->id ? 'selected' : '' }}>{{ $item->name }}</option>
                                                        @endforeach
                                                    </select>
                                                </td>
                                                <td width="100">
                                                ...
                                                <td rowspan="5" id="status_amount">
                                                    <input type="text" class="table-input text-center" disabled name="" id="status_amount_input" onchange="onCalculation('')">
                                                </td>
                                                <td rowspan="5">
                                            ...
                                            <tr id="second_row">
                                                ...
                                                <td>
                                                    <input type="text"class="table-input" name="finish_colour" id="finish_colour" onchange="onCalculation('')" value={{$chosenData['paint_colour']}}>
                                                </td>
                                                <td>
                                                ...
                                                <td>
                                                    <select class="form-control form-control-solid" name="finish_third" id="finish_third" onchange="onCalculation('')">
                                                        ...
                                                        @foreach ($data as $item)
                                                            <option value="{{ $cnt1++ }}"  {{$chosenData['edge_profile'] == $cnt1-1 ? 'selected' : '' }}>{{ $item }}</option>
                                                        @endforeach
                                                    </select>
                                                </td>
                                                <td>
                                                    ...
                                                    <select class="form-control form-control-solid" name="finish_finish" id="finish_finish" onchange="onCalculation('')">
                                                        <option value=""></option>
                                                            @foreach ($finish as $item)
                                                                <option value="{{ $item['id'] }}"  {{$chosenData['finish'] == $item->id ? 'selected' : '' }}>{{ $item['name'] }}</option>
                                                            @endforeach
                                                    </select>
                                                </td>
                                                <td>
                                ...
                                <div class="text-right btn-add-more-order">
                                    ...
                                    <button type="button" class="btn btn-primary mr-2" onclick="onSaveNext()">Save & Next</button>
                                    <a href="{{route('toPaintedDoorSecond')}}" class="btn mr-2 order-cancel-btn">Cancel</a>
                                </div>
                            </div>
...
<div id="kt_scrolltop" class="scrolltop">
    ...
    <script>
        ...
        function onGetFixedResponse(response, index){
            var chosen_finish = "{{$chosenData['finish']}}";
        ...
        function onAddMoreOrder(){
            ...
            html += `<tbody style="border: 1px solid black; position: relative">
                        <tr id="first_row` + more_cnt + `">
                            ...
                            <td rowspan="5" id="status_amount` + more_cnt + `">
                                <input type="text" class="table-input text-center" disabled name="" id="status_amount_input` + more_cnt + `" onchange="onCalculation(` + more_cnt + `)">
                            </td>
                            <td rowspan="5">
                                <textarea rows="10" class="table-input" name="comment" id="comment"></textarea>
                            </td>
        ...
        function onSaveNext(){
            // var arr = $('input[id=status_amount_input]').map(function() {
            //         return this.value;
            //     }).get();
