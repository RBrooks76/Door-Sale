...
<div class="d-flex flex-column flex-root">
    ...
    <div class="d-flex flex-row flex-column-fluid page">
        ...
        <div class="d-flex flex-column flex-row-fluid wrapper" id="kt_wrapper">
            ...
            <!--begin::Container-->
            <div class="d-flex flex-row flex-column-fluid container" style="margin-top: 50px">
                                                    ...
                                                    <div class="content flex-column-fluid" id="kt_content">
                                                        <div class="row">
                                                            <div class="form-group row col-lg-6">
                                                                ...
                                                                <div class="col-lg-6 col-md-9 col-sm-12">
                                                                    <div class="input-group date">
                                                                        <input type="text" class="form-control" id="kt_datepicker_2" readonly="readonly" placeholder="Select date" name="ordered_date" value="{{ $title->ordered_date }}">
                                                            ...
                                                            <div class="form-group row col-lg-6">
                                                                ...
                                                                <div class="col-lg-6 col-md-9 col-sm-12">
                                                                    <div class="input-group date">
                                                                        <input type="text" class="form-control" id="kt_datepicker_1" readonly="readonly" placeholder="Select date" name="required_date" value="{{ $title->required_date }}">
                                                                        <div class="input-group-append">
                                                                            <span class="input-group-text">
                                                                                <i class="la la-calendar-check-o"></i>
                                                                            </span>
                                                    ...
                                                    <div class="col-lg-12 my-2">
                                                        <div class="row">
                                                            <div class="form-group col-lg-6">
                                                                ...
                                                                <div class="col-10">
                                                                    <input class="form-control" type="text" id="customer" name="customer" value="{{ $title->customer }}">
                                                                </div>
                                                            </div>
                                                            <div class="form-group col-lg-6">
                                                                <label class="col-6 col-form-label">Company Name</label>
                                                                <div class="col-10">
                                                                    <input class="form-control" type="text" id="company" name="company" value="{{ $title->company }}">
                                                                </div>
                                                            </div>
                                                        ...
                                                        <div class="row">
                                                            <div class="form-group col-lg-6">
                                                                ...
                                                                <div class="col-10">
                                                                    <input class="form-control" type="text" id="delivery_address" name="delivery_address" value="{{ $title->delivery_address }}">
                                                                </div>
                                                            </div>
                                                            <div class="form-group col-lg-6">
                                                                <label class="col-6 col-form-label">Delivery State</label>
                                                                <div class="col-10">
                                                                    <input class="form-control" type="text" id="delivery_state" name="delivery_state" value="{{ $title->delivery_state }}">
                                                                </div>
                                                            </div>
                                                        ...
                                                        <div class="row">
                                                            <div class="form-group col-lg-6">
                                                                ...
                                                                <div class="col-10">
                                                                    <input class="form-control" type="text" id="job" name="job" value="{{ $title->job_ref }}">
                                                                </div>
                                                            </div>
                                                            <div class="form-group col-lg-6">
                                                                <label class="col-6 col-form-label">Mobile</label>
                                                                <div class="col-10">
                                                                    <input class="form-control" type="text" id="mobile" name="mobile" value="{{ $title->mobile }}">
                                                                </div>
                                                            </div>
                                                        </div>
                                                    </div>
                                        ...
                                        <table class="col-lg-12 table" id="table">
                                            <thead class="">
                                                <tr class="top-header">
                                                    ...
                                                    <th colspan="2" width="">Hinge Position </th>
                                            ...
                                            @foreach($orders as $key => $order)
                                                @php
                                                    $key == 0 ? '' : $key;
                                                @endphp
                                                <tbody style="border: 1px solid black; position: relative">
                                                    <tr id="first_row{{$key}}">
                                                        <td rowspan="5" width="50">
                                                            <span id="form_count">{{$key+1}}</span>
                                                        </td>
                                                        <td rowspan="5" width="150">
                                                            <select class="form-control form-control-solid" name="door_category" id="door_category{{$key}}" onchange="onChangeDoorCategory({{$key}})" value="{{ $order->category }}">
                                                                <option value=""></option>
                                                                @foreach ($doorstyle as $item)
                                                                    <option value="{{ $item->id }}" {{ $order->category == $item->id ? 'selected' : '' }}>{{ $item->name }}</option>
                                                                @endforeach
                                                            </select>
                                                        </td>
                                                        <td width="100">
                                                        ...
                                                        <td width="150">
                                                            <select class="form-control form-control-solid" name="finish_style" id="finish_style{{$key}}" onchange="onCalculation({{$key}})">
                                                                @foreach ($styles[$key] as $style)
                                                                    <option value="{{$style->id}}" {{ $style->id == $order->style ? 'selected' : '' }}>{{$style->style_name}}</option>
                                                                @endforeach
                                                            </select>
                                                        </td>
                                                        <td width="100">
                                                            <span id="finish_material_title{{$key}}"></span>
                                                        </td>
                                                        <td width="150">
                                                            <select class="form-control form-control-solid" name="finish_material" id="finish_material{{$key}}" onchange="onCalculation({{$key}})">
                                                                @foreach ($materials[$key] as $material)
                                                                    <option value="{{ $material->id }}" {{$material->id == $order->material ? 'selected' : ''}}>{{$material->name}}</option>
                                                                @endforeach
                                                            </select>
                                                        </td>
                                                        <td width="100">
                                                            <span id="hardware_first_title{{$key}}"></span>
                                                        </td>
                                                        <td width="150">
                                                            <select class="form-control form-control-solid" name="hardward_first" id="hardware_first{{$key}}" onchange="onCalculation({{$key}})">

                                                            </select>
                                                        </td>
                                                        <td width="100">
                                                            <span id="dimension_first_title{{$key}}"></span>
                                                        </td>
                                                        <td width="100">
                                                            <input type="text" class="table-input" name="dimension_first" id="dimension_first{{$key}}" onchange="onCalculation({{$key}})">
                                                        </td>
                                                        <td>
                                                            <input type="text" class="table-input" name="" onchange="onCalculation({{$key}})">
                                                        </td>
                                                        <td>
                                                            <input type="text" class="table-input" name="" onchange="onCalculation({{$key}})">
                                                        </td>
                                                        <td rowspan="4" id="status_amount">
                                                            <input type="text" class="table-input" name="" id="status_amount_input{{$key}}" onchange="onCalculation({{$key}})">
                                                        </td>
                                                        <td rowspan="5">
                                                            <textarea rows="10" class="table-input" name="comment" id="comment{{$key}}"></textarea>
                                                        </td>
                                                        <td rowspan="5">
                                                            <button type="button" class="btn btn-primary" onclick="onSaveOrder({{$key}})">Save</button>
                                                        </td>
                                                    </tr>
                                                    <tr id="second_row{{$key}}">
                                                        <td>
                                                            <span>colour</span>
                                                        </td>
                                                        <td>
                                                            <input type="text"class="table-input" name="finish_colour" id="finish_colour{{$key}}" onchange="onCalculation({{$key}})">
                                                        </td>
                                                        <td>
                                                            <span id="finish_third_title{{$key}}"></span>
                                                        </td>
                                                        <td>
                                                            <select class="form-control form-control-solid" name="finish_third" id="finish_third{{$key}}" onchange="onCalculation({{$key}})">
                                                                @php
                                                                    $data = ['A', 'B', 'C', 'D', 'E', 'F', 'G'];
                                                                    $cnt1 = 0;
                                                                @endphp
                                                                ...
                                                                @foreach ($data as $item)
                                                                    <option value="{{ $cnt1++ }}"  {{ $cnt1 == $order->finish_third ? 'selected' : '' }}>{{ $item }}</option>
                                                                @endforeach
                                                            </select>
                                                        </td>
                                                        <td>
                                                            <span id="hardware_second_title{{$key}}"></span>
                                                        </td>
                                                        <td>
                                                            <select class="form-control form-control-solid" name="hardware_second" id="hardware_second{{$key}}" onchange="onCalculation({{$key}})">

                                                            </select>
                                                        </td>
                                                        <td>
                                                            <span id="dimension_second_title{{$key}}"></span>
                                                        </td>
                                                        <td>
                                                            <input type="text"class="table-input" name="dimension_second" id="dimension_second{{$key}}" onchange="onCalculation({{$key}})">
                                                        </td>
                                                        <td>
                                                            <input type="text"class="table-input" name="" onchange="onCalculation({{$key}})">
                                                        </td>
                                                    ...
                                                    <tr id="third_row{{$key}}">
                                                        ...
                                                        <td>
                                                            <select class="form-control form-control-solid" name="finish_finish" id="finish_finish{{$key}}" onchange="onCalculation({{$key}})">
                                                                <option value=""></option>
                                                                    @foreach ($finishs as $item)
                                                                        <option value="{{ $item['id'] }}" {{ $order->finish == $item->id ? 'selected' : '' }}>{{ $item->name }}</option>
                                                                    @endforeach
                                                            </select>
                                                        </td>
                                                        <td>
                                                            <span id="finish_fourth_title{{$key}}"></span>
                                                        </td>
                                                        <td>
                                                            <select class="form-control form-control-solid" name="finish_fourth" id="finish_fourth{{$key}}" onchange="onCalculation({{$key}})">
                                                                @php
                                                                    $data = ['A', 'B', 'C', 'D', 'E', 'F', 'G'];
                                                                    $cnt1 = 0;
                                                                @endphp
                                                        ...
                                                        <td>
                                                            <span id="hardware_third_title{{$key}}"></span>
                                                        </td>
                                                        <td>
                                                            <select class="form-control form-control-solid" name="hardware_third" id="hardware_third{{$key}}" onchange="onCalculation({{$key}})">

                                                            </select>
                                                        </td>
                                                        <td>
                                                            <span id="dimension_third_title{{$key}}"></span>
                                                        </td>
                                                        <td>
                                                            <input type="text"class="table-input" name="dimension_third" id="dimension_third{{$key}}" onchange="onCalculation({{$key}})">
                                                        </td>
                                                        <td>
                                                            <input type="text"class="table-input" name="" onchange="onCalculation({{$key}})">
                                                        </td>
                                                    ...
                                                    <tr id="fourth_row{{$key}}">
                                                        <td>
                                                            <span id="finish_first_title{{$key}}"></span>
                                                        </td>
                                                        <td>
                                                            <select class="form-control form-control-solid" name="finish_first" id="finish_first{{$key}}" onchange="onCalculation({{$key}})">
                                                                @foreach ($finish_first as $first)
                                                                    @if(count($first) !== 0)
                                                                        {{-- <option value="{{$first->id}}" {{$order->finish_first == $first->id ? 'selected' : ''}}>{{ $first->name }}</option> --}}
                                                                    @endif
                                                                @endforeach
                                                            </select>
                                                        </td>
                                                        <td>
                                                            <span id="finish_fifth_title{{$key}}"></span>
                                                        </td>
                                                        <td>
                                                            <select class="form-control form-control-solid" name="finish_fifth" id="finish_fifth{{$key}}" onchange="onCalculation({{$key}})">
                                                                <option value=""></option>
                                                                <option value="1">True</option>
                                                            </select>
                                                        </td>
                                                        <td>
                                                            <span id="hardware_fourth_title{{$key}}"></span>
                                                        </td>
                                                        <td>
                                                            <select class="form-control form-control-solid" name="hardware_fourth" id="hardware_fourth{{$key}}" onchange="onCalculation({{$key}})">

                                                            </select>
                                                        </td>
                                                        <td>
                                                            <span id="dimension_fourth_title{{$key}}"></span>
                                                        </td>
                                                        <td>
                                                            <input type="text"class="table-input" name="dimension_fourth" id="dimension_fourth{{$key}}" onchange="onCalculation({{$key}})">
                                                        </td>
                                                        <td>
                                                            <input type="text"class="table-input" name="" onchange="onCalculation({{$key}})">
                                                        </td>
                                                    ...
                                                    <tr id="fifth_row{{$key}}">
                                                        <td>
                                                            <span id="finish_second_title{{$key}}"></span>
                                                        </td>
                                                        <td>
                                                            <select class="form-control form-control-solid" name="finish_second" id="finish_second{{$key}}" onchange="onCalculation({{$key}})">

                                                            </select>
                                                        </td>
                                                        <td>
                                                            <span id="finish_sixth_title{{$key}}"></span>
                                                        </td>
                                                        <td>
                                                            <select class="form-control form-control-solid" name="finish_sixth" id="finish_sixth{{$key}}" onchange="onCalculation({{$key}})">
                                                                <option value=""></option>
                                                                @php
                                                                    $six = [1, 2, 3, 4];
                                                                @endphp
                                                        ...
                                                        <td>
                                                            <span id="hardware_fifth_title{{$key}}"></span>
                                                        </td>
                                                        <td>
                                                            <select class="form-control form-control-solid" name="hardware_fifth" id="hardware_fifth{{$key}}" onchange="onCalculation({{$key}})">

                                                            </select>
                                                        </td>
                                                        <td>
                                                            <span id="dimension_fifth_title{{$key}}"></span>
                                                        </td>
                                                        <td>
                                                            <input type="text"class="table-input" name="dimension_fifth" id="dimension_fifth{{$key}}" onchange="onCalculation({{$key}})">
                                                        </td>
                                                        <td>
                                                            <input type="text"class="table-input" name="" onchange="onCalculation({{$key}})">
                                                        </td>
    ...
    <script>
        ...
        function onAllHide(){
            @php
                $number = count($orders);
            @endphp
            var amountoforder = <?php echo $number; ?>;
            for(var i=0; i< amountoforder; i++){
                i = (i == 0? '' : i);
                onHide(i);
            }
        }
        ...
        function onAddMoreOrder(){
            ...
            html += `<tbody style="border: 1px solid black; position: relative">
                        <tr id="first_row` + more_cnt + `">
                            ...
                            <td rowspan="5">
                                <textarea rows="10" class="table-input" name="comment"></textarea>
                            </td>
                            <td rowspan="5">
                        ...
                        <tr id="fifth_row` + more_cnt + `">
                            ...
                            <td>
                                <select class="form-control form-control-solid" name="finish_sixth" id="finish_sixth` + more_cnt + `" onchange="onCalculation(` + more_cnt + `)">
                                    <option value=""></option>
